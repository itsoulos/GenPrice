...
Random Search is presented here. This method is designed to estimate the global
minimum of multidimensional functions.
...
new version is compared against the original using some benchmark functions from the relevant litearature.
}
\begin{document}
